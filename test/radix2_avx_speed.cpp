...
#include <metaFFT/radix2_avx.h>
#include <metaFFT/radix2_avx_kernel.h>
...
void compare()
{
    ...
    {
        using namespace metaFFT::radix2::avx;
        compare<metaFFT::radix2::split::fft<N, std::complex<float_type>, bit_reverse_policy, butterfly_policy>>(N, "avx", runs, fftw_flops);
    }
